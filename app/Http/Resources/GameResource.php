...
use App\Http\Resources\TeamGameResource;
...
class GameResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
			...
			"team_1_image" => $this->team_1_image,
			"team_2_image" => $this->team_2_image,
			"queue_type" => $this->queue_type,
			"status" => $this->status,
            "team_1" => new TeamResource($this->team1),
            "team_2" => new TeamResource($this->team2),
